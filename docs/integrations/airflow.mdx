---
title: "Airflow provider for Datris: trigger and monitor taps from a DAG"
sidebarTitle: "Apache Airflow"
description: "Install airflow-provider-datris from PyPI, add a Datris connection, and run Datris taps as Airflow 3 tasks with streamed logs and XCom metrics."
---
