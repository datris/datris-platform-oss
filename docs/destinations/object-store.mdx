---
title: "Write Parquet or ORC files to MinIO object storage"
sidebarTitle: "Object Store (MinIO)"
description: "Write validated pipeline output as Parquet or ORC files to the built-in MinIO object store for a lakehouse or query engine to pick up."
---
