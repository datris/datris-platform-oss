---
title: "Embed documents into pgvector for RAG"
sidebarTitle: "pgvector"
description: "Chunk, embed, and upsert PDFs, Word docs, and text into PostgreSQL with the pgvector extension for retrieval-augmented generation."
---

Use this destination when you want a RAG index inside PostgreSQL you already run, built by a repeatable pipeline instead of a one-off script.
