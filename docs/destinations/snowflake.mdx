---
title: "Load data into Snowflake from an AI agent or pipeline"
sidebarTitle: "Snowflake"
description: "Bulk-load into Snowflake with PUT and COPY INTO, MERGE upserts, key-pair auth, and per-pipeline credentials."
---

Use this destination when you want an agent or a scheduled pipeline to land validated data in Snowflake without handing it warehouse credentials directly. Each pipeline references its own secret, and every load is audited and lineage-tracked.
