...
MongoDB connection credentials are configured globally in `application.yaml` via `secrets.mongoDbSecretName`. See [Configuration Reference](../configuration-reference.md) for Vault secret format.
