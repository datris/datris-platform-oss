---
title: "Publish pipeline output to ActiveMQ"
sidebarTitle: "ActiveMQ"
description: "Write validated pipeline output as messages to an ActiveMQ queue."
---

Use this destination when downstream systems consume from ActiveMQ and you want the messages validated before they are queued.
