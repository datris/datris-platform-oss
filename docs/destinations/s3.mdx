---
title: "Write Parquet or ORC files to AWS S3 from a pipeline"
sidebarTitle: "S3 (AWS)"
description: "Write validated pipeline output as Parquet or ORC files to AWS S3 with per-bucket credentials and region."
---
