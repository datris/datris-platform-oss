---
title: "Embed documents into Milvus for RAG"
sidebarTitle: "Milvus"
description: "Chunk, embed, and upsert documents into a Milvus collection for retrieval-augmented generation and semantic search."
---

Use this destination when you want a Milvus index built and refreshed by a repeatable pipeline, with chunking and embedding handled for you.
