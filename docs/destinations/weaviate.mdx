---
title: "Embed documents into Weaviate for RAG"
sidebarTitle: "Weaviate"
description: "Chunk, embed, and upsert PDFs, Word docs, text, and HTML into a Weaviate class for retrieval-augmented generation."
---

Use this destination when you want a Weaviate index built and refreshed by a repeatable pipeline, with chunking and embedding handled for you.
