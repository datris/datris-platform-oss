...
The embedding API is shared with other vector database destinations (e.g., Qdrant). See [Qdrant documentation](/destinations/qdrant#embedding-api) for full details.
