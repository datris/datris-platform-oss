...
<Update label="v1.8.9" description="June 22, 2026">
  **Version history for taps and pipelines, plus a faster assistant.**
  ...
  - **A snappier assistant.** The in-product assistants now run on a faster conversational model, while tap-script and code generation keep using the strongest coding model — chat feels quicker without trading away code quality.
