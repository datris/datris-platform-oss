...
1. Each destination loader (PostgreSQL, MongoDB, Kafka, ActiveMQ, Object Store, REST Endpoint, Qdrant, Weaviate, Milvus, Chroma, pgvector) publishes a notification to `VirtualTopic.{environment}-pipeline-notification`
