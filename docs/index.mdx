...
- **AI providers** - Anthropic Claude (choose any model), OpenAI (chose any model, plus embeddings models), Azure OpenAI (the same OpenAI models served from your Azure resource), or local models via Ollama (Llama, Mistral, Phi). No vendor lock-in — switch providers without changing your pipeline config
...
- [AI Configuration](/ai-configuration) - Configure AI providers (Anthropic, OpenAI, Azure OpenAI, Ollama)
