...
- **Embedding providers** - Bundled TEI (`bge-m3`, the default — runs locally, no API key), OpenAI, or Ollama (local models)
...
- [AI Configuration](/ai-configuration) - Configure AI providers (Anthropic, OpenAI, Ollama)
