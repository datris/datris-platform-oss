---
title: "Data lineage for AI agents"
sidebarTitle: "Provenance & Lineage"
description: "Trace any landed row back to the run, config version, script commit, and source that produced it. Agents query the same graph to check impact before changing anything and to find datasets by meaning."
---
