...
## Step 3 — Install the Datris memory skill
...
This pulls the latest published version of the skill, drops it at `~/.openclaw/workspace/skills/datris-memory/skill.md`, and you're done. Skip ahead to Step 4.
...
## Step 5 — Kick off the bootstrap, then use it
