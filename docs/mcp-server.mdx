...
| Tool | Description |
|------|-------------|
| `create_tap` | Create a tap from an instruction (AI generates script), a user-provided script, or config only. Optionally set target pipeline, CRON schedule, and secret name |
