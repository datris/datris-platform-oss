...
| Dataset discovery (`/discover` chat + full enumeration) | Yes — looks up the source's current docs and dataset list before enumerating; catches new datasets and retired endpoints |
