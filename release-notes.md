...
- **Changes made through the assistant are marked in the audit log.** They are attributed to the signed-in admin, exactly as if made in the sub-tab, and carry `via: config-chat` in their detail.
