...
class MCPActivityAPIController {
    ...
    private def formatNumericTs(root: JsonObject, arrayField: String, tsFields: Seq[String], sdf: java.text.SimpleDateFormat): Unit = {
    ...
    private def addLookupField(root: JsonObject, arrayField: String, hintToLabel: Map[String, String], targetField: String): Unit = {
